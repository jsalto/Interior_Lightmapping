...
Properties {
	...
	_WaterAlpha("Water Alpha", Range(0.0,1.0)) = 0.5
}
...
half4 frag( v2f i ) : SV_Target
{
	...
	//color = 0.1 * refr + 0.1 * refl + 0.8 * fresnel;
	...
	//color.rgb = 0.8 * water.rgb + 0.2 * refl.rgb;
	...
	//color.rgb = 0.8 * water.rgb + 0.2 *  _HorizonColor.rgb;
